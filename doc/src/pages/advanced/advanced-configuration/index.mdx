...
This passes the `env_id` variable to the Cloud Pak Deployer, which can then populate variables in the configuration. In the dynamic sample configuration, the `env_id` is used to specify the name of the VPC, ROKS cluster etc.:
