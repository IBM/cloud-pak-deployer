...
* Restore the `cloud-pak-deployer`, configuration and status directories to the bastion server
* Export the CONFIG_DIR and STATUS_DIR environment variables to respectively point to the configuration directory and the status directory
...
### On the bastion server that is not connected to the internet but is connected to the OpenShift cluster
* Restore the `cloud-pak-deployer`, configuration and status directories to the bastion server
* Export the CONFIG_DIR and STATUS_DIR environment variables to respectively point to the configuration directory and the status directory
