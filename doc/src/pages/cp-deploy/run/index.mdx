...
If you want to pull the Cloud Pak images from the entitlted registry (i.e. an online install), or if you want to mirror the images to your private registry namespace, you need to create a secret called `ibm_cp_entitlement_key` and set its value to your entitlement key. Create this secret unless the Cloud Pak images are already mirrored to the private registry.
```
