...
<InlineNotification kind="warning">
  WIP - TODO: update other tabs once finished!
</InlineNotification>
...
```
./cp-deploy.sh env apply -e env_id=pluto-01 -e azure_location=westeurope
```

<InlineNotification kind="warning">
  WIP - TODO: update info about how to get a different location, run: 'az
