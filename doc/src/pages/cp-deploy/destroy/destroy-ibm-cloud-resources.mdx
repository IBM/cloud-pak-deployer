...
If you have previously used the Cloud Pak Deployer to create resources on IBM Cloud, you can destroy the resources such as ROKS cluster, VSIs, VPCs with the same command. In the below steps we assume you have already created an IBM Cloud API Key.
