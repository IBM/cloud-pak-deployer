...
Before starting the configuration, take a look at the [basic and extended topologies](./topologies) to plan your infrastructure, OpenShift cluster and Cloud Pak.
