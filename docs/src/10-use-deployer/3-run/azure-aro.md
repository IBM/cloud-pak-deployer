...
There are 5 main steps to run the deployer for Azure (ARO):
...
4. [Set environment variables](#4-set-environment-variables-for-azure-aro)
...
# 4. Set environment variables for Azure ARO
