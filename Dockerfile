...
RUN mkdir -p /Data/downloads && \ 
    ...
    wget -O /Data/downloads/cloudctl.tar.gz https://github.com/IBM/cloud-pak-cli/releases/download/$(curl -s https://api.github.com/repos/IBM/cloud-pak-cli/releases/latest | jq -r .tag_name)/cloudctl-linux-amd64.tar.gz && \
    tar -xvzf /Data/downloads/cloudctl.tar.gz -C /usr/local/bin && \
